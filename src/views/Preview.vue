<template>
    <div id="main" class="h-screen text-body-text bg-body-bg overflow-y-auto">
        <div class="grid gap-4 grid-cols-1 m-auto pb-12 pt-8 px-4 max-w-screen-lg select-none md:grid-cols-2">
            <section class="relative md:col-span-2">
                ...
                <div class="flex items-center justify-center my-4 w-full">
                    <Button
                        size="sm"
                        class="w-full text-primary-btn-text text-lg bg-primary-btn shadow-primary-btn"
                        @click="toHomePage"
                    >
                        <span class="leading-6">Your Account? Connect now!</span>
                    </Button>
                </div>
            </section>
            ...
            <BarCard color="nft">
                ...
                <template #content>
                    <NFTItem
                        class="mr-1 cursor-not-allowed blur-sm filter"
                        v-for="item in nfts"
                    ...
                    >
                        <div v-if="footprints.length > 0" class="divide-footprint-divider divide-y-xs">
                            ...
                            <FootprintCard
                                ...
                                class="cursor-not-allowed blur-sm filter"
                                :class="{
                    ...
                    >
                        ...
                        <div class="inline-flex p-4 overflow-x-auto" style="scrollbar-width: thin">
                            <FootprintItem
                                ...
                                :imageUrl="item.info.image_preview_url"
                                :size="78"
                                class="flex-shrink-0 mr-2 cursor-not-allowed blur-sm filter"
                            />
                        </div>
                    </div>
                    <div v-else>
        ...
        <!-- <div
            class="onboarding flex items-center justify-center h-full text-center bg-cover bg-fixed"
        >
        ...
        <!-- <Modal>
                ...
                <template #body>
                    <p class="mt-1 p-4">
                        This account is not on RSS3 yet. Connect now if it's yours!
                    </p>
                </template>
                <template #footer>
                    <div class="flex flex-row gap-5">
